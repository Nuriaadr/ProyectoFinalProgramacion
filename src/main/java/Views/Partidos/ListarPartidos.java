 ...
 * @author nuria
 */
public class ListarPartidos extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ListarPartidos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarPartidos();
    }
   ...
   dispose();        // TODO add your handling code here:
    ...
    private void cargarPartidos() {
        DefaultListModel<Partido> modelo = new DefaultListModel<>();
        PartidoDAO dao = new PartidoDAO();
        List<Partido> lista = dao.listarTodos();
