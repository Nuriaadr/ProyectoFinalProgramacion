 ...
 * @author nuria
 */
public class BorrarParticipaciones extends javax.swing.JDialog {

    /**
     * Creates new form BorrarArbitro
     */
    public BorrarParticipaciones(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Introduzca el id de la participación a borrar:");
    ...
    private void BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BorrarActionPerformed
        ...
        if (!idTexto.isEmpty()) {
            try {
                ...
                ParticipacionDAO participacionesDAO = new ParticipacionDAO();
                int confirm = JOptionPane.showConfirmDialog(this, "¿Estás seguro de que quieres borrar la participación con ID " + id + "?", "Confirmar borrado", JOptionPane.YES_NO_OPTION);
                if (confirm == JOptionPane.YES_OPTION) {
                    participacionesDAO.eliminar(id);
                    JOptionPane.showMessageDialog(this, "Participación borrada correctamente.");
                    dispose();
                }
